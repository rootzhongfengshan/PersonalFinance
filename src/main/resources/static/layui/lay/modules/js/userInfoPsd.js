...
layui.define(['layer', 'form','element','jquery','laydate','upload'], function(exports){
    ...
    $('.layui-upload-icon').html('<i class="layui-icon">&#xe621;</i> 批量导入员工')
...
//				$wrapper.spinModal();
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return  '<a class="set-a" href="javascript:;" onclick="layer.queryHandle(this)">查看详情</a>' +
                                    ...
                                    '<a class="set-a" href="javascript:;" onclick="layer.modifyHandle(this)">修改密码</a>' +
                    ...
                    columns: [
                        {
                            ...
                            width: "30px",
                            render: function (data, type, row, meta) {
                                return  ' <input type="radio" name="chose" value="" title="&nbsp;">' ;
                            }
                        },
                        {
                            width: '',
    ...
    //修改密码
    layer.modifyHandle=function (obj) {
        //页面层
        layer.open({
    ...
    exports('userInfoPsd', {}); //注意，这里是模块输出的核心，模块名必须和use时的模块名一致
});
