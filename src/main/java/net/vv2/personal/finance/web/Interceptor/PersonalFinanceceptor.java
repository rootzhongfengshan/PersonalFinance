package net.vv2.personal.finance.web.Interceptor;
 ...
 **/
public class PersonalFinanceceptor extends HandlerInterceptorAdapter {
    @Override
    public boolean preHandle(HttpServletRequest httpServletRequest,
        ...
        if (user == null){
            String msg = "请先登陆网站！";
            String url = "<meta http-equiv=\"refresh\" content=\"3;url=/PersonalFinance/index\">";
