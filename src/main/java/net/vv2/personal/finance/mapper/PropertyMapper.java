...
public interface PropertyMapper {
    ...
    int insertProperty(net.vv2.personal.finance.domain.Property property);
    /**
     * 更新数据
     * @param property
     * @return int
    ...
    int updateProperty(net.vv2.personal.finance.domain.Property property);
    /**
     * 删除
     * @param id
     * @return int
    ...
    List<net.vv2.personal.finance.domain.Property> selectAll();
    ...
    net.vv2.personal.finance.domain.Property selectPropertyById(Integer id);
    ...
    List<Map<String, Object>> selectPropertyByDateReturnMap(@Param("start_date") String start_date, @Param("end_date") String end_date);
}
