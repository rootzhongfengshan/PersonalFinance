...
public interface IncomeMapper {
    ...
    List<Map<String, Object>> selectIncomeByDateReturnMap(@Param("start_date") String start_date, @Param("end_date") String end_date);

    @Select("select detail name,cast(sum(rec_amount) AS char) value from t_income_statement where  rec_date between #{start_date} and #{end_date} group by detail")
    List<Map<String, String>> selectIncomeByDateGroupByDetail(@Param("start_date") String start_date, @Param("end_date") String end_date);
}
